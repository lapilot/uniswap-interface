...
export const UNISWAP_NFT_AIRDROP_CLAIM_ADDRESS = '0xCBd3039e09221332D8B103A8F5Afc7377C26B6c0'

export const V2_FACTORY_ADDRESSES: AddressMap = constructSameAddressMap(V2_FACTORY_ADDRESS)
export const V2_ROUTER_ADDRESS: AddressMap = constructSameAddressMap('0x4f32101085A836e0E24913Fc7CD681799C42EA09')

// celo v3 addresses
const PILOT_TESTNET_V3_CORE_FACTORY_ADDRESSES = '0xfA548bc9bF266FC9be6daC3D94335336Cd605f29'
const PILOT_TESTNET_V3_MIGRATOR_ADDRESSES = '0xbb44eD2517565FF0f26Ce0D15D0C71baF044bD59'
const PILOT_TESTNET_MULTICALL_ADDRESS = '0x5884a73212C6718FfcEf5b30FdD625905e587953'
const PILOT_TESTNET_QUOTER_ADDRESSES = '0xcCEcD69cDb052ff3aE788e20a3E1dfCDd446c58f'
const PILOT_TESTNET_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = '0xa9681249DDa73deea6545961FF0648AD1EBa504C'
const PILOT_TESTNET_TICK_LENS_ADDRESSES = '0xDA5faB6D558FD006a7a33db146128e8dC29445FC'
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_V3_CORE_FACTORY_ADDRESSES,
...
export const V3_MIGRATOR_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_V3_MIGRATOR_ADDRESSES,
...
export const MULTICALL_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_MULTICALL_ADDRESS,
...
export const ROUTER_ADDRESS: AddressMap = {
  ...constructSameAddressMap('0x4648a43B2C14Da09FdF82B161150d3F634f40491', [
  ...
  [SupportedChainId.MAINNET]: '0xEf1c6E67703c7BD7107eed8303Fbe6EC2554BF6B',
  [SupportedChainId.POLYGON]: '0x4C60051384bd2d3C01bfc845Cf5F4b44bcbE9de5',
  [SupportedChainId.OPTIMISM]: '0xb555edF5dcF85f42cEeF1f3630a52A108E55A654',
  [SupportedChainId.ARBITRUM_ONE]: '0x4C60051384bd2d3C01bfc845Cf5F4b44bcbE9de5',
  [SupportedChainId.CELO]: '0xC73d61d192FB994157168Fb56730FdEc64C9Cb8F',
  [SupportedChainId.BNB]: '0x5Dc88340E1c5c6366864Ee415d6034cadd1A9897',
  [SupportedChainId.PILOT_TESTNET]: '0x4709351ecF43C26948443F2CCaC31204c5116871',
}
...
export const QUOTER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_QUOTER_ADDRESSES,
...
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
...
export const TICK_LENS_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.PILOT_TESTNET]: PILOT_TESTNET_TICK_LENS_ADDRESSES,
